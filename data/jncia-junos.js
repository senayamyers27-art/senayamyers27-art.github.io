...
CertHub.register({
  ...
  questions: [
    ...
    ["jj43",0,4,"How many committed configurations, including the active one, does Junos keep for rollback?",["10","20","32","50"],3,"Junos stores rollback 0 through 49, which is 50 configurations. Rollback 0 is the active one.","Objective 4"],
