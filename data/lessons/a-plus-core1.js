...
CertHub.addLessons("a-plus-core1", [
 ...
 },
 {
  ...
  "check": [
   ...
   [
    ...
    "It tells receiving servers how to handle mail that fails SPF or DKIM checks and where to send reports."
   ],
   [
 ...
 },
 {
  ...
  "body": [
   ...
   "Step 4 is to establish a plan of action to resolve the problem and implement the solution, taking into account vendor instructions and any corporate change procedures. For example, replacing a server drive may need to wait for a maintenance window. Step 5 is to implement the solution or escalate as necessary. Step 6 is to verify full system functionality and, if applicable, implement preventive measures. Confirm with the user that everything works, not just the one symptom, and consider how to stop it happening again, such as scheduling updates or adding a surge protector.",
   "Step 7 is to document findings, actions and outcomes, usually in the ticketing system. Record the symptoms, the cause, what you tried, what fixed it and any follow-up. Good documentation helps the next technician, builds a knowledge base of known fixes and shows patterns such as a batch of failing devices. A useful memory aid for the order is: identify, theorize, test, plan, implement, verify, document."
  ],
  "terms": [
   [
