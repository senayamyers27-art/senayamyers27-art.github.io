...
CertHub.addLessons("sscp", [
 {
  ...
  "tip": "Memorize the order: protect society first, then act honorably and legally, then serve principals, then advance the profession. When two canons conflict, choose the answer that satisfies the higher-numbered priority (canon one beats canon three).",
  "check": [
   [
 ...
 },
 {
  ...
  "tip": "HSM versus TPM: an HSM serves many systems and applications and is often a separate appliance; a TPM is soldered into one device and protects that device. Dual control and split knowledge are the answers for preventing a single person from misusing a master key.",
  "check": [
   [
