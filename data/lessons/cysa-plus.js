...
CertHub.addLessons("cysa-plus", [
 ...
 },
 {
  ...
  "body": [
   ...
   "Other related measures include dwell time (how long an attacker was present before being detected; some organizations measure until eradication instead), the percentage of incidents detected internally versus reported by outsiders, automation rate (share of alerts handled by SOAR without manual work) and SLA compliance for response times by severity. Present trends over time, and connect them to actions: new detection content should lower MTTD, SOAR playbooks should lower response time and alert volume per analyst, and tuning should raise the true positive rate."
  ],
  "terms": [
   [
    "MTTD",
