...
CertHub.addLessons("jncia-junos", [
 ...
 },
 {
  ...
  "example": "A service provider wants every core-facing interface to run OSPF point-to-point with the same hello settings. It writes a group with `protocols ospf area 0 interface <ge-*>` settings, applies it under protocols, and uses `apply-groups-except` on the one management interface that must not run OSPF.",
