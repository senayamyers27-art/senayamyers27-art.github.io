...
CertHub.addLessons("terraform", [
 ...
 },
 {
  ...
  "body": [
   ...
   "This pattern is what the week's lab asks you to try: adding the community `kreuzwerker/docker` provider next to `local` shows one workflow managing two unrelated platforms. Run `terraform providers` to list every provider the configuration requires and which module requires it."
  ],
  "terms": [
   [
 ...
 },
 {
  ...
  "body": [
   ...
   "None of these commands change state or infrastructure. For changing state there is a separate group (`state mv`, `state rm`, `state pull`, `state push`, `state replace-provider`), which you should use carefully and preferably replace with configuration-driven blocks such as `moved` and `removed`."
  ],
  "terms": [
   [
    "terraform state list",
