...
CertHub.addLessons("sc-200", [
 ...
 },
 {
  ...
  "body": [
   ...
   "Live response opens a remote shell session on the device from the portal. Basic commands let you list processes, view files, collect files with getfile, and run scripts that are already in the live response library. Advanced live response, which must be enabled in settings, lets you upload and run your own scripts; unsigned scripts need a separate setting. All commands are logged. Use live response when you need detail no standard action gives you, such as pulling a specific log.",
  ...
  "check": [
   ...
   [
    ...
    "Advanced live response features in settings, plus the setting for unsigned scripts if they are unsigned."
   ],
   [
 ...
 },
 {
  ...
  "terms": [
   ...
   [
    "MailItemsAccessed",
    "An Audit (Premium) event that shows which mailbox items were accessed."
   ]
  ],
  ...
  "tip": "Questions asking 'who did what, when' in Microsoft 365 point to a Purview Audit search. 'Which emails did the attacker read' points to MailItemsAccessed in Audit (Premium).",
  "check": [
   [
