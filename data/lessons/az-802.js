...
CertHub.addLessons("az-802", [
 ...
 },
 {
  ...
  "body": [
   ...
   "For Azure to Azure, no on-premises components are needed. When you enable replication for a VM, ASR installs the Site Recovery Mobility extension automatically, creates target resources such as a resource group, virtual network and cache storage in the paired or chosen region, and begins replicating. Crash-consistent recovery points are created frequently, and app-consistent points on the schedule in the replication policy.",
 ...
 },
 {
  ...
  "terms": [
   ...
   [
    "ReFS",
    "Resilient File System, which checksums data, self-repairs with Storage Spaces mirrors and supports fast block cloning."
   ],
   [
    "Data Deduplication",
  ...
  "check": [
   ...
   [
    ...
    "Block cloning makes checkpoint merges and fixed VHDX creation fast, and checksums with automatic repair protect large volumes."
   ],
   [
 ...
 },
 {
  ...
  "terms": [
   ...
   [
    "Cache tier",
    "The fastest drives in an S2D node, automatically used to cache reads and writes for the slower capacity drives."
   ],
   [
