...
CertHub.addLessons("palo-alto-ngfw", [
 {
  ...
  "tip": "If a question says the firewall must be added 'with no network changes' or 'without IP addresses', the answer is virtual wire. If it must only observe and never block, it is tap. Routing and VPN termination require Layer 3.",
  "check": [
   [
