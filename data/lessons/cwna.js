...
CertHub.addLessons("cwna", [
 ...
 },
 {
  ...
  "body": [
   ...
   "An AP-on-a-stick survey (also called a pre-deployment or validation survey) is used when no network exists yet or when you want to measure real propagation before finalizing a design. You mount a representative AP, configured with the power and channel you plan to use, on a tall stand or pole at a proposed mounting location, and then survey around it to see the actual cell boundary. You then move the AP to the next location. It gives very accurate results for difficult environments such as warehouses, hospitals and historic buildings, but it is labor-intensive and requires a portable power source for the AP.",
