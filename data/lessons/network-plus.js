...
CertHub.addLessons("network-plus", [
 ...
 },
 {
  ...
  "body": [
   ...
   "Switches and routers often have empty slots that accept pluggable transceivers, which convert electrical signals to the right medium. SFP (small form-factor pluggable) supports around 1 Gbps; SFP+ supports 10 Gbps; QSFP (quad SFP) and QSFP+ bundle four lanes for 40 Gbps; QSFP28 supports 100 Gbps. Transceivers must match on both ends: same speed, same wavelength and the correct fibre type. A single-mode optic plugged into multimode fibre, or mismatched wavelengths, will not form a reliable link. Bidirectional (BiDi) transceivers send and receive on one strand using two different wavelengths.",
 ...
 },
 {
  ...
  "body": [
   ...
   "Power over Ethernet (PoE) delivers DC power over the same twisted-pair cable as data, so IP phones, access points and cameras need no local power outlet. The switch is the power sourcing equipment (PSE) and the device is the powered device (PD). Standards: IEEE 802.3af (PoE) supplies up to 15.4 W per port at the switch; 802.3at (PoE+) up to 30 W; 802.3bt (sometimes called PoE++) Type 3 up to 60 W and Type 4 up to about 90-100 W. Some power is lost in the cable, so the device receives slightly less. Every PoE switch also has a total power budget. If a switch has a 370 W budget, it cannot power 24 devices that each draw 25 W (600 W), even though every port supports PoE+. When the budget is exceeded, some ports will not power up or devices reboot. Plan the budget and use `show power inline` to check usage.",
  ...
  "tip": "802.3af = 15.4 W, 802.3at (PoE+) = 30 W, 802.3bt = 60 or up to about 90-100 W. Every port supporting PoE+ does not mean the switch can power them all at full wattage; check the total budget.",
  "check": [
   [
