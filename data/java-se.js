...
CertHub.register({
  ...
  questions: [
    ...
    ["js89",0,10,"The default locale is en_US. The app has Messages.properties and Messages_fr.properties, and calls ResourceBundle.getBundle(\"Messages\", Locale.CANADA_FRENCH) (fr_CA). Which file is searched first for a key?",["Messages.properties","Messages_en_US.properties","Messages_fr.properties","A MissingResourceException is thrown"],2,"There is no Messages_fr_CA, so lookup falls back to Messages_fr. Keys missing there come from its parent, Messages.properties. The default locale is only tried if no bundle is found for fr at all.","Localization: resource bundles"],
