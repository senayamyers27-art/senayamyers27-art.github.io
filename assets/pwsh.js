...
(function (root) {
  ...
  function exec(S, t, input) {
    ...
    switch (cmd) {
      ...
      case "get-help": { const nm = opt.name || pos[0]; return nm ? `NAME\n    ${/* safe: terminal text, not HTML */ nm}\n\nSYNOPSIS\n    Simulated help for ${/* safe: terminal text, not HTML */ nm}. This practice session supports a subset of parameters.\n\nSYNTAX\n    ${/* safe: terminal text, not HTML */ nm} [-Name] [-Path] [<CommonParameters>]` : "Supported cmdlets: " + CMDS.join(" "); }
